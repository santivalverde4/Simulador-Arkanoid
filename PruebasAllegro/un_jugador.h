...
int un_jugador(int& vidas, int nivel) {
	if (!al_init()) {
	...
	ALLEGRO_BITMAP* marcoarriba = al_load_bitmap("Imagenes/MarcoArriba.png");
	...
	plataforma plataforma_abajo = { ResolucionX / 2 - 600, ResolucionY - 100, 10, 150, 30, al_load_bitmap("Imagenes/plataforma1.png") };

	bola bola1 = { 200, 200, -5.0, 5.0, 200, 300, 35, 0, fotoBola };
	bola bola2 = { 300, 200, -5.0, 5.0, 200, 300, 35, 2, fotoBola };
	bola bola3 = { 400, 200, -5.0, 5.0, 200, 300, 35, 2, fotoBola };
	...
	while (hecho) {
		...
		if (bola1.bouncery < 225) {
			bola1.velocidady = -bola1.velocidady;
			estadisticas.bolasRebotadas += 1;
		}

		vidas_bolas1(bola1, bola2, bola3, ResolucionY, vidas, estadisticas.vidasGastadas);

		borrar_bolas1(bola1, bola2, bola3, ResolucionY, plataforma_abajo, vidas, estadisticas.bolasPerdidas);
		...
		colision_bola_enemigo(enemigo1, bola2.bouncerx, bola2.bouncery, bola2.velocidadx, bola2.velocidady, bola2.size, puntaje, estadisticas.bolasRebotadas, estadisticas.enemigosDestruidos);
		colision_bola_enemigo(enemigo2, bola2.bouncerx, bola2.bouncery, bola2.velocidadx, bola2.velocidady, bola2.size, puntaje, estadisticas.bolasRebotadas, estadisticas.enemigosDestruidos);
		colision_bola_enemigo(enemigo3, bola2.bouncerx, bola2.bouncery, bola2.velocidadx, bola2.velocidady, bola2.size, puntaje, estadisticas.bolasRebotadas, estadisticas.enemigosDestruidos);
		colision_bola_enemigo(enemigo4, bola2.bouncerx, bola2.bouncery, bola2.velocidadx, bola2.velocidady, bola2.size, puntaje, estadisticas.bolasRebotadas, estadisticas.enemigosDestruidos);

		colision_bola_enemigo(enemigo1, bola3.bouncerx, bola3.bouncery, bola3.velocidadx, bola3.velocidady, bola3.size, puntaje, estadisticas.bolasRebotadas, estadisticas.enemigosDestruidos);
		colision_bola_enemigo(enemigo2, bola3.bouncerx, bola3.bouncery, bola3.velocidadx, bola3.velocidady, bola3.size, puntaje, estadisticas.bolasRebotadas, estadisticas.enemigosDestruidos);
		colision_bola_enemigo(enemigo3, bola3.bouncerx, bola3.bouncery, bola3.velocidadx, bola3.velocidady, bola3.size, puntaje, estadisticas.bolasRebotadas, estadisticas.enemigosDestruidos);
		colision_bola_enemigo(enemigo4, bola3.bouncerx, bola3.bouncery, bola3.velocidadx, bola3.velocidady, bola3.size, puntaje, estadisticas.bolasRebotadas, estadisticas.enemigosDestruidos);
		...
		while (actual != NULL) {
			if (obtenerNumeroAleatorio() == 1)
				actual->pintarLadrillo(bola1, bola2, bola3, puntaje, powerUpAzul, enemigo1);
			else if ((obtenerNumeroAleatorio() == 2))
				actual->pintarLadrillo(bola1, bola2, bola3, puntaje, powerUpVerde, enemigo2);
			else
				actual->pintarLadrillo(bola1, bola2, bola3, puntaje, powerUpRoja, enemigo3);
		...
		// Dibujar marcoarriba centrado
		al_draw_scaled_bitmap(marcoarriba,
			0, 0, al_get_bitmap_width(marcoarriba), al_get_bitmap_height(marcoarriba), // Origen
			70, 170, // Posición en la pantalla
			al_get_bitmap_width(marcoarriba) * 0.78, al_get_bitmap_height(marcoarriba) / 2, // Tamaño en la pantalla
			0);
	...
	if (vidas == 0) {
		...
		while (seguir) {
			...
			al_wait_for_event(cola_eventos, &eventos2);
			al_clear_to_color(al_map_rgb(0, 0, 0));
			al_draw_text(font1, colorBlanco, ResolucionX / 2, ResolucionY / 2 - 50, ALLEGRO_ALIGN_CENTRE, "PRECIONE ENTER PARA CONTINUAR");
